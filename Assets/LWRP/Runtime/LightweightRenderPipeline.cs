    ...
    public sealed partial class LightweightRenderPipeline : RenderPipeline
    {
        ...
        static void SetSupportedRenderingFeatures()
        {
            ...
            SupportedRenderingFeatures.active = new SupportedRenderingFeatures()
            {
                ...
                supportedMixedLightingModes = SupportedRenderingFeatures.LightmapMixedBakeMode.Subtractive | SupportedRenderingFeatures.LightmapMixedBakeMode.Shadowmask,
        ...
        static void InitializeCameraData(PipelineSettings settings, Camera camera, out CameraData cameraData)
        {
            ...
            if (additionalCameraData != null)
            {
                ...
                cameraData.requiresRenderedTexture = additionalCameraData.requiresRenderedTexture;
            }
            else
            {
                cameraData.requiresDepthTexture = settings.supportsCameraDepthTexture;
                cameraData.requiresOpaqueTexture = settings.supportsCameraOpaqueTexture;
                cameraData.requiresRenderedTexture = false;
            }
