    ...
    public class RenderOpaqueForwardPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderer renderer, ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingSample(cmd, k_RenderOpaquesTag))
            {
                ...
                RenderBufferLoadAction colorLoadOp = clearFlag != ClearFlag.None && clearFlag != ClearFlag.Depth ? RenderBufferLoadAction.DontCare : RenderBufferLoadAction.Load;
                RenderBufferLoadAction depthLoadOp = clearFlag != ClearFlag.None ? RenderBufferLoadAction.DontCare : RenderBufferLoadAction.Load;
                RenderBufferStoreAction storeOp = RenderBufferStoreAction.Store;

                SetRenderTarget(cmd, colorAttachmentHandle.Identifier(), colorLoadOp, storeOp,
                    depthAttachmentHandle.Identifier(), depthLoadOp, storeOp, clearFlag, clearColor, descriptor.dimension);
