...
namespace UnityEngine.Experimental.Rendering.LightweightPipeline
{
    ...
    public class LWRPAdditionalCameraData : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        [FormerlySerializedAs("requiresRenderedTexture"), SerializeField]
        bool m_RequiresRenderedTexture = false;
        ...
        public bool requiresRenderedTexture {
            get => m_RequiresRenderedTexture;
            set => m_RequiresRenderedTexture = value;
        }
