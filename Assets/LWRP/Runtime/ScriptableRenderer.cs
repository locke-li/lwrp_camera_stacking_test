    ...
    public sealed class ScriptableRenderer
    {
        ...
        public ScriptableRenderer(LightweightRenderPipelineAsset pipelineAsset)
        {
            ...
            m_Materials = new[]
            {
                ...
                CoreUtils.CreateEngineMaterial(pipelineAsset.blitFlipShader),
        ...
        public static bool RequiresIntermediateColorTexture(ref CameraData cameraData, RenderTextureDescriptor baseDescriptor)
        {
            ...
            return noAutoResolveMsaa || cameraData.isSceneViewCamera || isScaledRender || cameraData.isHdrEnabled
                   || cameraData.postProcessEnabled || cameraData.requiresOpaqueTexture || cameraData.requiresRenderedTexture
                   || isTargetTexture2DArray || !cameraData.isDefaultViewport;
        }
        ...
        public static ClearFlag GetCameraClearFlag(Camera camera)
        {
            ...
            */
            //modified: camera stacking
            if ((camera.clearFlags == CameraClearFlags.Skybox && RenderSettings.skybox != null) ||
                camera.clearFlags == CameraClearFlags.Nothing || camera.clearFlags == CameraClearFlags.Depth)
                return ClearFlag.Depth;
